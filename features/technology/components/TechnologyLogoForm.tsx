...
interface TechnologyLogoFormProps {
...
export default function TechnologyLogoForm({
    currentTechnology,
    onUploadComplete,
    onClose,
    loading = false,
}: TechnologyLogoFormProps) {
    const [file, setFile] = useState<File | null>(null);
    const [preview, setPreview] = useState<string | null>(currentTechnology.logoUrl || null);
